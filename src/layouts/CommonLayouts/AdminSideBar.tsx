...
const AdminSideBar = () => {
  ...
  return (
    <aside className={`h-screen z-10 ${extended ? "fixed" : ""} md:sticky  top-0 bg-background`}>
      <nav className="relative h-full flex flex-col border-r border-primary shadow-sm">
        <div className=" p-4 px-6 flex w-fit items-center">
          ...
          >
            <Link href={"/admin/home"}> LITTLEMOMENTS </Link>
          </div>
          {!extended ? (
